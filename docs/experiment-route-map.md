...
| `/v/n8t4cw` | Alpha | Screen white space | More whitespace | M5 | Uses smaller summary and project cards with larger gaps between them |
...
| `/v/c2x7pk` | Beta | Screen white space | More whitespace | M5 | Uses smaller course cards with substantially larger column and row gaps |
