...
| `/v/n8t4cw` | Alpha | Screen white space | More whitespace | M5 | Increases outer, section, panel, navigation, card, and row spacing while retaining the baseline grid |
...
| `/v/c2x7pk` | Beta | Screen white space | More whitespace | M5 | Increases section gaps, card padding, and vertical margins while retaining the baseline grid |
